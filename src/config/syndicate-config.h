/* src/config/syndicate-config.h.  Generated from syndicate-config.h.in by configure.  */
/* src/config/syndicate-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef SYNX_CONFIG_H

#define SYNX_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.synx.online"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Syndicate Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Syndicate Core 2.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "syndicate"
