...
BitcoinGUI::BitcoinGUI(const NetworkStyle* networkStyle, QWidget* parent) : QMainWindow(parent),
                                                                            ...
                                                                            labelTorIcon(0), //dJAX update code for #626 issues
                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    //dJAX update code for #566 issues Start
    ...
    //dJAX update code for #566 issues End
    ...
    labelEncryptionIcon->setMaximumSize(STATUSBAR_ICONSIZE, STATUSBAR_ICONSIZE);
     //dJAX update code for #626 issues
    ...
    if (enableWallet) {
        ...
        frameBlocksLayout->addStretch();
        frameBlocksLayout->addWidget(labelAutoMintIcon);//dJAX update code for #566 issues
        frameBlocksLayout->addStretch();
    ...
    connect(labelAutoMintIcon, SIGNAL(clicked()), this, SLOT(optionsClicked())); //dJAX update code for #566 issues
...
void BitcoinGUI::setClientModel(ClientModel* clientModel)
{
    ...
    if (clientModel) {
        ...
        connect(clientModel->getOptionsModel(), SIGNAL(zeromintEnableChanged(bool)), this, SLOT(setAutoMintStatus()));//dJAX update code for #568 issues
...
#endif // ENABLE_WALLET
//dJAX updated code for #626 issues Start
...
//dJAX updated code for #626 issues End
