...
//dJAX update code for #572 issues
static void NotifySYNXReset(WalletModel* walletmodel)
{
    qDebug() << "NotifySYNXReset";
...
void WalletModel::subscribeToCoreSignals()
{
    ...
    wallet->NotifySYNXReset.connect(boost::bind(NotifySYNXReset, this));//dJAX update code for #572 issues
}
...
void WalletModel::unsubscribeFromCoreSignals()
{
    ...
    wallet->NotifySYNXReset.disconnect(boost::bind(NotifySYNXReset, this));//dJAX update code for #572 issues
}
