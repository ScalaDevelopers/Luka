...
#include <QtWidgets>
  ...
  PrivacyDialog::PrivacyDialog(QWidget* parent) : QDialog(parent, Qt::WindowSystemMenuHint | Qt::WindowTitleHint | Qt::WindowCloseButtonHint | Qt::WindowCloseButtonHint), //dJAX update code for #629 issues
...
void PrivacyDialog::setModel(WalletModel* walletModel)
{
    ...
    if (walletModel && walletModel->getOptionsModel()) {
        ...
        connect(walletModel->getOptionsModel(), SIGNAL(zeromintEnableChanged(bool)), this, SLOT(updateAutomintStatus()));//dJAX update code for #571 issues
        connect(walletModel->getOptionsModel(), SIGNAL(zeromintPercentageChanged(int)), this, SLOT(updateAutomintStatus()));//dJAX update code for #571 issues
                               ...
                               const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    ui->labelzSYNXAmountValue->setText(BitcoinUnits::floorHtmlWithUnit(nDisplayUnit, balance - immatureBalance - nLockedBalance, false, BitcoinUnits::separatorAlways));
         ...
         updateAutomintStatus(); //dJAX update code for #571 issues
...
//dJAX update code for #571 issues Start
...
//dJAX update code for #571 issues END
