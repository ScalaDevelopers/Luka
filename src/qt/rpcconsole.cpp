...
void RPCExecutor::request(const QString& command)
{
  ...
  RPCConsole::RPCConsole(QWidget* parent) : QDialog(parent, Qt::WindowSystemMenuHint | Qt::WindowTitleHint | Qt::WindowCloseButtonHint),  //dJAX update code for #629 issues
